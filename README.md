...
아래 주소 하나를 등록하면 저장소의 모든 확장을 설치하고 업데이트할 수 있습니다.
...
| DC_Toki webtoon | 1.4.2 | 파란 토끼 | Webtoon (최적화 테스트) |
...
| WFWF (`wfwf webtoon` + `wfwf manga`) | 1.4.5 | 녹색 토끼 | 빠른 직접 로딩, 1,000회 이상 전체 회차, 검색, 설정에서 도메인 번호 변경 |
...
3. 저장소를 새로고침합니다.
4. 필요한 확장을 설치하거나 업데이트합니다.

이 프로젝트는 Tachimanga, Mihon, Tachiyomi 또는 대상 사이트와 제휴하지 않은 개인용 수정본입니다.
